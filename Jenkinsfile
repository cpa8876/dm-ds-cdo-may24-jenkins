              ...
              script {
                  ...
                  sh '''
                     ...
                     then  
                      ...
                      kubectl exec -t cast-db-postgres-0 -n $name_branch -- /bin/bash -c "psql -h localhost -p 5432 -U cast_fastapi_user_$name_branch -d cast_fastapi_db_$name_$branch -c 'select * from pg_database'"
