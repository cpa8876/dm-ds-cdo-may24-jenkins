...
pipeline {
  environment { // Declaration of environment variables
    ...
    DOCKER_IMAGE1="movies-ds-fastapi"                                       // DOCKER_IMAGE1="movies-ds-fastapi"
            ...
            steps{
              ...
              script {
                  ...
                  sh '''
                     ...
                     echo  "\n\n### 50_15_05) Test with a cmd curl after to have deployed cast-fastapi-$name_branch on the branch: $name_branch on the environment:  $name_branch, with cmd : \n$: kubectl run --rm -it  --tty pingkungcurl4 --image=curlimages/curl --namespace develop --restart=Never -- cast-fastapi-service:$podPortcast/casts/api/v1/casts/docs";
                      kubectl run --rm -it  --tty pingkungcurl4 --image=curlimages/curl --namespace develop --restart=Never -- cast-fastapi-service:$podPortcast/api/v1/casts/docs
